...
description: Automate end-to-end testing of web applications using Bugster CLI. Use when the user asks to generate tests, run test suites, or perform automated browser testing. Triggers include "test", "check", "verify", "tests", "generate tests", "run tests", "execute tests", "test automation", "E2E tests", "end-to-end", "automated testing", "create test specs". When executing commands, provide detailed and specific instructions.
